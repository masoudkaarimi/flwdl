...
export default function Content() {
   ...
   return (
      <>
         <SubHeading title={"About"} breadcrumb={[{ name: "Home", href: "/" }, { name: "About" }]} />
         ...
         >
            ...
            <Typography variant={"body2"} color={"text.secondary"} gutterBottom>
               ...
               profile Picture using this service. All of them will be saved in original quality to your phone or
               computer.
            </Typography>
            <Typography variant={"body2"} color={"text.secondary"} gutterBottom>
            ...
            <Typography variant={"body2"} color={"text.secondary"} gutterBottom>
               You will quickly find where to tap to download Instagram profile Picture and videos. The interface of the
